...
public class AdminApiMappingProfile : Profile
{
    public AdminApiMappingProfile()
    {
        ...
        CreateMap<EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.ClaimSet, ClaimSetDetailsModel>()
            .ForMember(dst => dst.Id, opt => opt.MapFrom(src => src.Id))
            .ForMember(dst => dst.Name, opt => opt.MapFrom(src => src.Name))
            .ForMember(dst => dst.IsSystemReserved, opt => opt.MapFrom(src => !src.IsEditable));

        CreateMap<EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.ClaimSet, ClaimSetModel>()
            .ForMember(dst => dst.Id, opt => opt.MapFrom(src => src.Id))
            .ForMember(dst => dst.Name, opt => opt.MapFrom(src => src.Name));

        CreateMap<EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.ResourceClaim, ResourceClaimModel>()
            .ForMember(dst => dst.Name, opt => opt.MapFrom(src => src.Name))
        ...
        CreateMap<EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.AuthorizationStrategy, AuthorizationStrategyModel>()
        ...
        CreateMap<AuthorizationStrategyModel, EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.AuthorizationStrategy>()
            .ForMember(dst => dst.AuthStrategyId, opt => opt.MapFrom(src => src.AuthStrategyId))
            .ForMember(dst => dst.AuthStrategyName, opt => opt.MapFrom(src => src.AuthStrategyName))
            .ForMember(dst => dst.DisplayName, opt => opt.MapFrom(src => src.DisplayName))
            .ForMember(dst => dst.IsInheritedFromParent, opt => opt.MapFrom(src => src.IsInheritedFromParent));

        CreateMap<SecurityCompatiblity53.DataAccess.Models.AuthorizationStrategy, EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.AuthorizationStrategy>()
        ...
        CreateMap<EdFi.Security.DataAccess.Models.AuthorizationStrategy, EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.AuthorizationStrategy>()
            .ForMember(dst => dst.AuthStrategyName, opt => opt.MapFrom(src => src.AuthorizationStrategyName))
            .ForMember(dst => dst.AuthStrategyId, opt => opt.MapFrom(src => src.AuthorizationStrategyId))
            .ForMember(dst => dst.IsInheritedFromParent, opt => opt.Ignore());

        CreateMap<ResourceClaimModel, EdFi.Ods.Admin.Api.Infrastructure.ClaimSetEditor.ResourceClaim>()
            .ForMember(dst => dst.Name, opt => opt.MapFrom(src => src.Name))
            .ForMember(dst => dst.Read, opt => opt.MapFrom(src => src.Read))
            .ForMember(dst => dst.Update, opt => opt.MapFrom(src => src.Update))
            .ForMember(dst => dst.Create, opt => opt.MapFrom(src => src.Create))
