...
{
    public class SqlServerCloudOdsDatabaseSecurityConfigurator : ICloudOdsDatabaseSecurityConfigurator
    {
        ...
        public SqlServerCloudOdsDatabaseSecurityConfigurator(IRawSqlConnectionService rawSqlConnectionService, ICloudOdsDatabaseNameProvider cloudOdsDatabaseNameProvider)
        {
