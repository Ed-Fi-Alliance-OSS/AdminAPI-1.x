...
namespace EdFi.Ods.AdminApp.Web.Display.TabEnumeration
{
    public sealed class OdsInstanceSettingsTabEnumeration : Enumeration<OdsInstanceSettingsTabEnumeration>, ITabEnumeration
    {
        ...
        public static readonly OdsInstanceSettingsTabEnumeration BulkLoad = new OdsInstanceSettingsTabEnumeration(6, "Bulk Load", RouteHelpers.GetControllerName<BulkUploadController>(), RouteHelpers.GetActionName<BulkUploadController>(x => x.Index()));
