...
{
    public class AzureCloudOdsDatabaseSqlServerSecurityConfiguration : ICloudOdsDatabaseSqlServerSecurityConfiguration
    {
                    ...
                    Users = new[]
                    {
                        new CloudOdsDatabaseUser
                        {
                            ...
                            Roles = new[]
                            {
                                ...
                                CloudOdsSqlServerRoles.DataWriter,
                                CloudOdsSqlServerRoles.Executor,
                                CloudOdsSqlServerRoles.DatabaseDdlAdmin
                            }
                        },
                        new CloudOdsDatabaseUser
                        {
