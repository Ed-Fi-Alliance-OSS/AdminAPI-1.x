...
namespace EdFi.Ods.AdminApp.Management.Azure
{
    public class GetAzureCloudOdsApiWebsiteSettingsQuery : IGetCloudOdsApiWebsiteSettingsQuery
    {
        ...
        public GetAzureCloudOdsApiWebsiteSettingsQuery(AzureActiveDirectoryClientInfo azureActiveDirectoryClientInfo, GetAzureCloudOdsHostedComponentsQuery getAzureCloudOdsHostedComponentsQuery, 
